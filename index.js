...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Tiago\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5544997462158:+55 4499746-2158\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD TIAGO BOT*',
			...
			const mod = [ownerNumber,"5544997462158@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5544997462158@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5544997462158@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5544997462158@s.whatsapp.net"]
...
//msc fim
			...
			switch(command) {
				...
				case 'menu1':
					...
					if (!isOwner) return reply('voce nao é o Tiago 😠')
		...
		case 'halloweentext':
		    ...
		    break
                ...
                case 'tratag':
                    ...
                    dark.sendMess('5544997462158@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO TIAGO BOT👑* 」\n\`\`\``
					no = 0
          ...
          reply('Espere..')
			...
			reply(mess.wait)
				...
				case 'limpar':
					...
					break
				case 'bc':
					if (!isOwner) return reply('Quem é Você, você não é o tiago 😂?')
