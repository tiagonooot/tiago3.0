...
const vcard = 'BEGIN:VCARD\n' //
            ...
            + 'ORG:Creator EREN;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=554497462158:+5544997462158\n' //
            + 'END:VCARD'
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["5544997462158@s.whatsapp.net","554497462158@s.whatsapp.net"]
			const mod = [ownerNumber,"5544997462158@s.whatsapp.net","554497462158@s.whatsapp.net"]
			const adminbotnumber = ["5544997462158@s.whatsapp.net","554497462158@s.whatsapp.net"]
			const frendsowner = ["5544997462158@s.whatsapp.net","554497462158@s.whatsapp.net"]
			const premium = ["5544997462158@s.whatsapp.net","554497462158@s.whatsapp.net"]
